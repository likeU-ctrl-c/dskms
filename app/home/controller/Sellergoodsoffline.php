...
class  Sellergoodsoffline extends BaseSeller {
    ...
    public function goods_storage() {
        ...
        switch ($type) {
            ...
            case 'lock_up':
                ...
                $goods_list = $goods_model->getGoodsLockUpList($condition);
                break;
            // 等待审核或审核失败的商品
            case 'wait_verify':
                /* 设置卖家当前菜单 */
                ...
                if (isset($verify) && in_array($verify, array('0', '10'))) {
                    $condition[]=array('goods_verify','=',$verify);
                }
            ...
            default:
                ...
                $goods_list = $goods_model->getGoodsOfflineList($condition);
                break;
        }
    ...
    public function goods_show() {
        ...
        $condition = array();
        $condition[] = array('goods_id','in',$goods_id_array);
        $condition[] = array('store_id','=',session('store_id'));
