...
//                    array('name' => 'member_invoice', 'text' => lang('ds_member_invoice'), 'url' => url('Memberinvoice/index'),),
                    ...
                    array('name' => 'member_goodscourses', 'text' => lang('ds_member_goodscourses'), 'url' => url('MemberGoodscourses/index'),),
                    array('name' => 'member_exampaper', 'text' => lang('ds_memberexampaper_log'), 'url' => url('Memberexampaper/log'),),
                    array('name' => 'member_exambanksuggest', 'text' => lang('ds_memberexambanksuggest'), 'url' => url('Memberexambanksuggest/index'),),
                )
            ),
            'assets' =>
            array(
