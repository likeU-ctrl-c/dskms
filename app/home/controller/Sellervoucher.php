...
class  Sellervoucher extends BaseSeller {
    ...
    public function templatelist() {
        ...
        if (input('param.txt_enddate')) {
            $condition[] = array('vouchertemplate_startdate','<=', strtotime(input('param.txt_enddate'))+86399);
        }

        $vouchertemplate_list = Db::name('vouchertemplate')->where($condition)->order('vouchertemplate_id desc')->paginate(10, false, ['query' => request()->param()]);
