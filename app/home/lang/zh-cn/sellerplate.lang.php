...
$lang['format_name_description']		= '请输入10个字符内的名称，方便课程发布 / 编辑时选择使用。';
$lang['layout_position']		= '版式位置';
$lang['top']		= '顶部';
$lang['bottom']		= '底部';
$lang['insert_description']		= '选择关联版式插入到页面中的位置，选择“顶部”为课程详情上方内容，“底部”为课程详情下方内容。';
...
$lang['action_prompt_instruction']		= '1、关联版式可以把预设内容插入到课程描述的顶部或者底部，方便机构对课程描述批量添加或修改。';
return $lang;
