...
//            'bank_address'=>'require',
    ...
    protected $message = [
        ...
        'company_name.length'=>'公司名称必须小于50个字',
//            'company_address.require|length:1,50'=>'公司地址不能为空|公司地址必须小于50个字',
        'company_address_detail.require'=>'公司详细地址不能为空',
        'company_address_detail.length'=>'公司详细地址必须小于50个字',
        'company_registered_capital.require'=>'注册资金不能为空',
        'company_registered_capital.float'=>'注册资金必须为数字',
        'contacts_name.require'=>'联系人姓名不能为空',
        'contacts_name.length'=>'联系人姓名必须小于20个字',
        'contacts_phone.require'=>'联系人电话不能为空',
        'contacts_phone.length'=>'联系人电话必须小于20个字',
        'contacts_email.require'=>'电子邮箱不能为空',
        'contacts_email.email'=>'电子邮箱格式不正确',
...
//            'business_licence_address.require|length:1,50'=>'营业执照所在地不能为空|营业执照所在地必须小于50个字',
        ...
        'bank_account_name.require'=>'银行开户名不能为空',
        'bank_account_name.length'=>'银行开户名必须小于50个字',
        'bank_account_number.require'=>'银行账号不能为空',
        'bank_account_number.length'=>'银行账号必须小于20个字',
        'bank_name.require'=>'开户银行支行不能为空',
        'bank_name.length'=>'开户银行支行必须小于50个字',
//            'bank_address.require'=>'开户行所在地不能为空',
        'settlement_bank_account_name.require'=>'银行开户名不能为空',
        'settlement_bank_account_name.length'=>'银行开户名必须小于50个字',
        'settlement_bank_account_number.require'=>'银行账号不能为空',
        'settlement_bank_account_number.length'=>'银行账号必须小于50个字',
        'settlement_bank_name.require'=>'开户银行支行不能为空',
        'settlement_bank_name.length'=>'开户银行支行必须小于50个字',
        'store_name.require'=>'机构名称不能为空',
        'store_name.length'=>'机构名称必须小于50个字',
        'storegrade_id.require'=>'机构等级不能为空',
        'storeclass_id.require'=>'机构分类不能为空',
        //sellerjoininc2c
        'business_sphere.require'=>'姓名不能为空',
        'business_sphere.length'=>'姓名不能小于50个字',
