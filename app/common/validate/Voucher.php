...
class  Voucher extends Validate
{
    protected $rule = [
        ...
        'promotion_voucher_buyertimes_limit'=>'require|number',
    ...
    protected $message = [
        ...
        'promotion_voucher_buyertimes_limit.require'=>'最大领取数量应为大于0的整数',
        'promotion_voucher_buyertimes_limit.number'=>'最大领取数量应为大于0的整数',
