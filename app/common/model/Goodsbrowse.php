...
class  Goodsbrowse extends BaseModel {
    ...
    public function getViewedGoodsList($member_id = 0, $shownum = 0) {
        ...
        if ($browselist) {
            $goods_list_tmp = model('goods')->getGoodsList(array(array('goods_id','in', array_keys($browselist))), 'goods_id, goods_name, goods_advword,goods_price, goods_image, store_id, gc_id, gc_id_1, gc_id_2, gc_id_3');
            $goods_list = array();
