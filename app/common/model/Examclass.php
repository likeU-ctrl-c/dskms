 ...
 * 数据层模型
 */
class Examclass extends BaseModel {
    ...
    public function getExamclassList($condition, $order = 'examclass_parent_id asc,examclass_sort asc,examclass_id asc') {
        $result = Db::name('examclass')->where($condition)->order($order)->select()->toArray();
        return $result;
    }
    ...
    public function getOneExamclass($condition) {
        $result = Db::name('examclass')->where($condition)->find();
        return $result;
    }
    ...
    public function addExamclass($data) {
        $result = Db::name('examclass')->insertGetId($data);
        return $result;
    }
    ...
    public function editExamclass($condition, $data) {
        $result = Db::name('examclass')->where($condition)->update($data);
        return $result;
    }
    ...
    public function delExamclass($condition) {
        return Db::name('examclass')->where($condition)->delete();
    }
