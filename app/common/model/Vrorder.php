    ...
    public function getVrorderOperateState($operate, $order_info) {
        ...
        switch ($operate) {
            ...
            case 'refund':
                ...
                if ($order_info['refund']=='1' && !$order_info['refund_state'] && $order_info['order_state'] == ORDER_STATE_PAY && ($order_info['payment_time'] + 60 * 60 * 24 * config('ds_config.order_refund_time')) > TIMESTAMP) {
                    $state = true;
                }
                break;
        }
