        ...
        return array(
            ...
            'goods' => array(
                ...
                'children' => array(
                    ...
                    'courseware' => array(
                        'ico' => '&#xe732;',
                        'text' => lang('ds_courseware_set'),
                        'args' => 'setting,Courseware,goods',
                    ),
                    'video' => array(
                        'ico'=>'&#xe6fa;',
                        'text' => lang('ds_video'),
                        'args' => 'index,Videoupload,goods',
                    ),
                    'album' => array(
                        'ico' => '&#xe72a;',
                        'text' => lang('ds_album'),
            ...
            'live' => array(
                ...
                'children' => array(
                    ...
                    'instant_message' => array(
                        ...
                        'args' => 'index,InstantMessage,live',
                    ),
                ),
            ),
        );
    ...
    function limitList() {
        $_limit = array(
            ...
            array('name' => lang('ds_goods'), 'child' => array(
                    ...
                    array('name' => lang('ds_video'), 'action' => null, 'controller' => 'Videoupload'),
            ...
            array('name' => lang('ds_operation'), 'child' => array(
                    array('name' => lang('ds_operation_set'), 'action' => null, 'controller' => 'Operation|Promotionxianshi|Voucher|Inviter|Bonus|Marketmanage|Pointprod|Pointorder|Rechargecard'),
                )),
            ...
            array('name' => lang('ds_exam'), 'child' => array(
                    array('name' => lang('ds_examclass'), 'action' => null, 'controller' => 'Examclass'),
                    array('name' => lang('ds_exambank'), 'action' => null, 'controller' => 'Exambank'),
                    array('name' => lang('ds_exampaper'), 'action' => null, 'controller' => 'Exampaper'),
                )),
