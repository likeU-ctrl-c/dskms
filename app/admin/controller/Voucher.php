...
class  Voucher extends AdminControl {
    ...
    public function priceedit() {
        ...
        if (request()->isPost()) {
            ...
            $voucher_model = model('voucher');
            $condition = array();
            $condition[]=array('voucherprice','=',$voucher_price);
            $condition[]=array('voucherprice_id','<>',$id);
            $voucherprice_info = $voucher_model->getOneVoucherprice($condition);
            if (!empty($voucherprice_info)) {
                $this->error(lang('admin_voucher_price_exist'));
            }
                $update_arr = array();
    ...
    public function index() {
        $condition = array();
        if (trim(input('param.store_name'))) {
            $condition[] = array('vouchertemplate_storename','like', "%{input('param.store_name')}%");
        }
