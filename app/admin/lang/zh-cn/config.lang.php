...
$lang['default_product_pic'] = '默认课程图片';
...
$lang['allowed_visitors_consult_notice'] = '允许游客在课程的详细展示页面，对当前课程进行咨询';
...
$lang['promotion_notice'] = '启用课程促销功能后，机构可以通过限时打折、满即送、优惠套装和推荐展位活动，对机构课程进行促销';
...
$lang['points_isuse_notice'] = '积分系统启用后，可设置会员的注册、登录、购买课程送一定的积分';
...
$lang['voucher_allow_notice'] = '代金券功能、积分功能、积分中心启用后，机构可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属机构内购买课程时，选择使用而得到优惠';
...
$lang['open_yes'] = '是';
$lang['open_no'] = '否';
$lang['is_goods_verify'] = '课程发布审核';
$lang['goods_verify_notice'] = '机构发布的课程是否需要通过平台的审核后才能上架';

$lang['is_goods_all_verify'] = '课程审核通过';
$lang['goods_all_verify_notice'] = '关闭课程审核后是否需要将之前待审核的课程全部审核通过';
