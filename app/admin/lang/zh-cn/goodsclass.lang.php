...
$lang['goods_class_index_class'] = '课程分类';
...
$lang['goods_class_index_help1'] = '店主添加课程的时候，可以选择课程的分类，用户可以根据课程的分类来查询课程列表';
$lang['goods_class_index_help2'] = '点击课程分类名前“+”符号，显示当前课程分类的下级分类';
$lang['goods_class_index_help3'] = '<a>对课程分类作任何更改后，都需要到 设置 -> 清理缓存，新的设置才会生效</a>';
/**
 * 批量编辑
 */
...
$lang['goods_class_edit_prompts_one'] = '课程类型关系到课程发布时，课程规格的添加，没有课程类型的课程分类将不能添加课程规格。';
$lang['goods_class_edit_prompts_two'] = '默认勾选"关联到子分类"将课程类型附加到该子分类，如子分类不同于上级分类的类型，可以取消勾选并单独对子分类的特定类型进行编辑选择。';
...
$lang['goods_class_export_if_trans'] = '导出您的课程分类数据';
$lang['goods_class_export_trans_tip'] = '';
$lang['goods_class_export_export'] = '导出';
$lang['goods_class_export_help1'] = '导出课程分类信息的.csv文件';
return $lang;
?>
