...
return [
    ...
    'storegrade_goods_limit'=>'可发布课程数',
    'storegrade_album_limit'=>'可上传图片数',
    'storegrade_space_limit'=>'可使用空间大小',
    'storegrade_cloud_limit'=>'可使用视频云空间大小',
    'storegrade_cloud_limit_tips'=>'0表示不限空间，单位MB',
    'storegrade_local_limit'=>'可使用视频本地空间大小',
    'storegrade_local_limit_tips'=>'0表示不限空间，单位MB',
